...
const registerUser = asyncHandler(async(req, res) => {
    ...
    const user = await User.create({
        ...
        email,
        fullName,
        avatar: avatar?.url || "https://res.cloudinary.com/vtubecloud/image/upload/v1754656557/default_avatar_krw1dq.jpg",
        coverImage: coverImage?.url || "https://res.cloudinary.com/vtubecloud/image/upload/v1754656657/default_coverImage_wjpwgl.jpg",
        bio: bio || "",
